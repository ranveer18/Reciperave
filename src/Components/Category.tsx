...
const Category = () => {
  return (
    <>
      <div className="category pt-32 max-[768px]:pt-16">
        <h1 className="text-5xl font-medium flex justify-center items-center my-5 text-[#03383F]">Our Category</h1>
        <div className="category-item-conatiner flex justify-center items-center gap-10 px-20 py-10 max-[768px]:px-5 max-[768px]:gap-4 max-[500px]:overflow-scroll">
