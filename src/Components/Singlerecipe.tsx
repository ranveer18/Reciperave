        ...
        <>
            <div className="flex flex-col">
                ...
                <div className="w-full bg-[#FEF8E6] h-auto flex text-[#03383F] max-[500px]:flex-col ">
                    ...
                    <div className="w-2/4 h-full px-20 pt-60 pb-10 flex flex-col gap-5 max-[786px]:px-10 max-[786px]:pt-10 max-[500px]:w-full">
                ...
                <div className="w-full bg-[#fbfaf4] h-screen flex flex-col text-[#03383F] py-20 px-40 gap-20 max-[786px]:px-16 max-[500px]:h-auto max-[500px]:px-5">
                    <h1 className="text-4xl font-bold text-[#03383F]">Methods</h1>
                    <div className="flex items-center gap-40 max-[500px]:gap-5">
                    ...
                    <div className="flex items-center gap-40 flex-row-reverse max-[500px]:gap-5">
                        <img src={method} className="w-40 h-40 max-[500px]:w-16" alt="" />
                        <div className="flex flex-col gap-3">
