...
const Contentcard = () => {
  return (
    <>
    <div className="flex flex-row gap-x-40 gap-y-20 my-5 flex-wrap justify-center items-center">
      <div className="w-96 h-auto flex justify-center items-center flex-col">
        <div className="image-container w-96 h-96 rounded bg-[#F9972F] flex justify-center items-center">
            <img src={pizza} alt="" className="w-96 h-96 rounded" />
        </div>
